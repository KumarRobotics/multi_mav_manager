...
alias circlel='rosservice call /multi_mav_services/goFormCircle "{roll: 0.0, pitch: 0.0, yaw: 0.0, center: [0.0, 0.0, 1.0], spacing: $SPACING}"'
...
rosservice call /multi_mav_services/goFormCircle "{roll: 0.0, pitch: 0.0, yaw: 0.0, center: [3.0, 0.0, 1.5], spacing: $SPACING}"
sleep 1

read -p "Press [Enter] to move rectangle away"
rosservice call /multi_mav_services/goFormRect "{roll: 0.0, pitch: 0.4, yaw: 0.0, center: [6.5, 0.0, 2.0], spacing: $SPACING}"
sleep 1

read -p "Press [Enter] to move Triangle towards"
rosservice call /multi_mav_services/goFormTriangle "{roll: 0.0, pitch: 0.7, yaw: 0.0, center: [5.5, 0.0, 1.5], spacing: $SPACING}"
sleep 1

read -p "Press [Enter] to expand circle. It can change"
rosservice call /multi_mav_services/goFormCircle "{roll: 0.0, pitch: 0.0, yaw: 0.0, center: [5.5, 0.0, 0.5], spacing: 0.8}"
sleep 1
...
read -p "Press [Enter] to expand circle. It can change"
rosservice call /multi_mav_services/goFormCircle "{roll: 0.0, pitch: 0.0, yaw: 0.0, center: [5.5, 0.0, 0.5], spacing: 1.35}"
sleep 1

read -p "Press [Enter] to expand circle. It can change"
rosservice call /multi_mav_services/goFormCircle "{roll: 0.0, pitch: 0.0, yaw: 0.0, center: [5.75, 0.0, 0.5], spacing: 0.8}"
sleep 1

read -p "Press [Enter] to form circle. We can make them go into formation"
rosservice call /multi_mav_services/goFormCircle "{roll: 0.5, pitch: 0.0, yaw: 0.0, center: [5.0, 0.0, 1.5], spacing: $SPACING}"
sleep 1

read -p "Press [Enter] to change to a rectangle"
rosservice call /multi_mav_services/goFormRect "{roll: 0.0, pitch: 0.6, yaw: 0.0, center: [5.5, 0.0, 1.5], spacing: $SPACING}"
sleep 1

read -p "Press [Enter] to change to a Triangle"
rosservice call /multi_mav_services/goFormTriangle "{roll: 0.0, pitch: 0.6, yaw: 0.0, center: [5.5, 0.0, 1.5], spacing: $SPACING}"
sleep 1

read -p "Press [Enter] to change to stairs"
rosservice call /multi_mav_services/goFormLine "{roll: 0.0, pitch: 0.6, yaw: 0.0, center: [5.5, 0.0, 1.25], spacing: 0.5}"
sleep 1

read -p "Press [Enter] to make a christmas miracle"
rosservice call /multi_mav_services/goFormAngle "{roll: 0.0, pitch: 1.59, yaw: 0.0, center: [5.5, 0.0, 2.0], spacing: 0.6}"
sleep 1

read -p "Press [Enter] to form circle"
rosservice call /multi_mav_services/goFormCircle "{roll: 0.0, pitch: 0.0, yaw: 0.0, center: [5.5, 0.0, 1.0], spacing: $SPACING}"
sleep 1
...
rosservice call /multi_mav_services/goFormCircle "{roll: 0.0, pitch: 0.0, yaw: 0.0, center: [5.5, 0.0, 0.1], spacing: $SPACING}"
sleep 1
