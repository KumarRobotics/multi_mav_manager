#include <kr_multi_mav_manager/multi_mav_services.h>
...
bool MMControl::goTo_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res)
{
...
bool MMControl::goToTimed_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res)
{
  return goForm(req, res);
}

bool MMControl::goFormRawPos_cb(kr_multi_mav_manager::RawPosFormation::Request &req, kr_multi_mav_manager::RawPosFormation::Response &res){
  ...
  kr_multi_mav_manager::Formation::Request form_req;
  kr_multi_mav_manager::Formation::Response form_res;
...
bool MMControl::goFormLine_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res)
{
...
bool MMControl::goFormTriangle_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res)
{
...
bool MMControl::goFormAngle_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res)
{
...
bool MMControl::goFormCircle_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res){
...
bool MMControl::goFormRect_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res){
...
bool MMControl::goFormGrid3d_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res){
...
void MMControl::cleanFormation(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res)
{
  //checkActiveRobots();
...
bool MMControl::goForm(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res)
{
  res.success = true;
...
bool MMControl::checkCapt(kr_multi_mav_manager::Formation::Response &res){
