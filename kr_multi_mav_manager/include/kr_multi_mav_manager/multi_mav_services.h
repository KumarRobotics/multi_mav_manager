...
#include <kr_multi_mav_manager/Formation.h>
#include <kr_multi_mav_manager/RawPosFormation.h>
#include <kr_multi_mav_manager/mav_manager_interface.h>
...
class MMControl
{
  ...
  private:
    ...
    bool goTo_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res);
    bool goToTimed_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res);

    bool goFormRawPos_cb(kr_multi_mav_manager::RawPosFormation::Request &req, kr_multi_mav_manager::RawPosFormation::Response &res);
    bool goFormLine_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res);
    bool goFormAngle_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res);
    bool goFormCircle_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res);
    bool goFormRect_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res);
    bool goFormGrid3d_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res);
    bool goFormTriangle_cb(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res);

    void cleanFormation(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res);
    bool goForm(kr_multi_mav_manager::Formation::Request &req, kr_multi_mav_manager::Formation::Response &res);
    bool checkCapt(kr_multi_mav_manager::Formation::Response &res);
    ...
    kr_multi_mav_manager::Formation::Request f_req;
    kr_multi_mav_manager::Formation::Response f_res;
